...
TODAY = date.today()  # date(2019, 1, 28)
battle_kind = "wtf"  # fb

QUEST_SCHEDULE = {
    "визитка": [date(2019, 1, 19), date(2019, 1, 20)],
    "тексты нерейтинг": [date(2019, 1, 26), date(2019, 1, 27)],
    # "драбблы нерейтинг": [date(2019, 1, 26), date(2019, 1, 27)],
    ...
    # "драбблы рейтинг": [date(2019, 2, 16), date(2019, 2, 17)],
...
VOTE_SCHEDULE = [
    {"name": "визитка", "beginning": date(2019, 1, 21), "end": date(2019, 2, 3),
     "out": "визитку"},
    {"name": "тексты нерейтинг", "beginning": date(2019, 1, 28), "end": date(2019, 2, 10),
     "out": "нерейтинговые тексты", "rating": False},
    # {"name": "драбблы нерейтинг", "beginning": date(2019, 1, 28), "end": date(2019, 2, 10),
    ...
    # {"name": "драбблы рейтинг", "beginning": date(2019, 9, 8), "end": date(2019, 9, 29),
